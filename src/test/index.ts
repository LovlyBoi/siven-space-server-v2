...
// readFile(resolve(__dirname, "./vite")).then(async (val) => {
//   const { id, location } = await storeMarkDown(val, "vite");
//   const blog: Blog = {
//     id,
//     author: "siven",
//     title: "智文的 Vite 笔记",
